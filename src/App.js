...
import './App.css';
import abhiImage from "./sravani.jpg"; 
...
function App() {
  ...
  return (
    <div className="App">
      <header>
        <div className="user">
          <img src={abhiImage} alt="Sravani" />
          <h3 className="name">Sravani</h3>
        </div>
      ...
      <section className="education" id="education">
        ...
        <div className="box-container">
          <div className="box">
            ...
            <span>2018-2019</span>
            <h3>SSC</h3>
            <p style={{ fontSize: '20px' }}>Pragathi Public High School</p>
          </div>
          <div className="box">
            <i className="fas fa-graduation-cap"></i>
            <span>2019-2021</span>
            <h3>Intermediate</h3>
            <h3>MPC</h3>
            <p style={{ fontSize: '20px' }}>Gotur Sanjeeva Reddy</p>
          </div>
          <div className="box">
            <i className="fas fa-graduation-cap"></i>
            <span>2021-2025</span>
      ...
      <section className="contact" id="contact">
        ...
        <div className="row">
          <div className="content">
            ...
            <div className="info">
              <h3> <i className="fas fa-envelope"></i> sravanigandla141@gmail.com</h3>
              <h3> <i className="fas fa-phone"></i> 9392622963 </h3>
